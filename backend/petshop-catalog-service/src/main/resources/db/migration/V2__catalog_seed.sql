...
('Spring Wellness Event', 'Save on grooming bundles and wellness essentials this month.', 'Limited Time', '15% Off Care', TRUE, CURRENT_TIMESTAMP - INTERVAL '2 days', CURRENT_TIMESTAMP + INTERVAL '20 days'),
('New Pet Starter Pack', 'Bundle food, carrier, and training toy for a smoother first week home.', 'Popular', 'Bundle Savings', TRUE, CURRENT_TIMESTAMP - INTERVAL '1 day', CURRENT_TIMESTAMP + INTERVAL '30 days')
ON CONFLICT DO NOTHING;
