INSERT INTO commerce.promo_codes (code, description, discount_type, discount_value, active, expires_at) VALUES
...
INSERT INTO commerce.wishlist_items (user_id, item_type, item_slug, item_name, image_url, unit_price) VALUES
...
INSERT INTO commerce.orders (owner_reference, user_id, customer_name, customer_email, customer_phone, shipping_address, city, state, postal_code, notes, status, payment_status, payment_reference, subtotal, discount_amount, total_amount, promo_code) VALUES
...
INSERT INTO commerce.inquiries (user_id, item_slug, item_type, customer_name, customer_email, phone, message, status) VALUES
...
INSERT INTO commerce.service_bookings (user_id, service_slug, service_name, pet_name, pet_type, appointment_date, notes, customer_name, customer_email, customer_phone, status) VALUES
...
INSERT INTO commerce.adoption_requests (user_id, pet_slug, pet_name, customer_name, customer_email, customer_phone, home_type, experience_level, notes, status) VALUES
...
INSERT INTO commerce.contact_messages (user_id, type, name, email, subject, message, status) VALUES
