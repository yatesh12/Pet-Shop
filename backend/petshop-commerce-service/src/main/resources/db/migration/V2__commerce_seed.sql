...
('WELCOME10', 'Ten percent off first order', 'PERCENT', 10.00, TRUE, CURRENT_TIMESTAMP + INTERVAL '90 days'),
('CARE20', 'Twenty dollars off service package orders', 'FIXED', 20.00, TRUE, CURRENT_TIMESTAMP + INTERVAL '45 days')
...
(2, 'signature-grooming', 'Signature Grooming', 'Buddy', 'Dog', CURRENT_DATE + 3, 'Sensitive skin, please use hypoallergenic shampoo.', 'Jamie Carter', 'jamie@example.com', '+1 555-0110', 'REQUESTED')
ON CONFLICT DO NOTHING;
